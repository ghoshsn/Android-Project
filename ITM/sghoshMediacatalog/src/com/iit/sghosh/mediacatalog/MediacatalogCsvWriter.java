 ...
 */
public class MediacatalogCsvWriter {
	...
	/**
	 * Creates a {@link com.MediacatalogCsvWriter.CsvWriter CsvWriter} object using a file
	 ...
	 *            writing the data.
	 */
	public MediacatalogCsvWriter(String fileName, char delimiter, Charset charset) {
		if (fileName == null) {
	 ...
	 *            The path to the file to output the data.
	 */
	public MediacatalogCsvWriter(String fileName) {
		this(fileName, Letters.COMMA, Charset.forName("ISO-8859-1"));
	}

	/**
	 * Creates a {@link com.MediacatalogCsvWriter.CsvWriter CsvWriter} object using a Writer
	 * to write data to.
	 * 
	 * @param outputStream
	 ...
	 *            The character to use as the column delimiter.
	 */
	public MediacatalogCsvWriter(Writer outputStream, char delimiter) {
	...
	/**
	 * Creates a {@link com.MediacatalogCsvWriter.CsvWriter CsvWriter} object using an
	 ...
	 *            writing the data.
	 */
	public MediacatalogCsvWriter(OutputStream outputStream, char delimiter, Charset charset) {
...
}  //end of class MediacatalogCsvWriter